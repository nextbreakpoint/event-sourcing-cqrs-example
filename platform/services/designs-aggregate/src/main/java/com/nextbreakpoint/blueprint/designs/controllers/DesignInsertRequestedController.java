...
public class DesignInsertRequestedController implements Controller<InputMessage, Void> {
    ...
    public DesignInsertRequestedController(DesignAggregate aggregate, Mapper<InputMessage, DesignInsertRequested> inputMapper, MessageMapper<DesignAggregateUpdateRequested, OutputMessage> outputMapper, MessageEmitter emitter) {
