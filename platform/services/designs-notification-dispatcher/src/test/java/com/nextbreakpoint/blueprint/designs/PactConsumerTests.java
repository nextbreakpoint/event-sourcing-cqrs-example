...
public class PactConsumerTests {
    ...
    @Test
    @PactTestFor(providerName = "designs-event-consumer", port = "1113", pactMethod = "tileAggregateUpdateCompleted", providerType = ProviderType.ASYNCH)
    ...
    @Test
    @PactTestFor(providerName = "designs-event-consumer", port = "1114", pactMethod = "tileAggregateUpdateCompleted", providerType = ProviderType.ASYNCH)
