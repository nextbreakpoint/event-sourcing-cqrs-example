...
public class IntegrationTests {
    ...
    public void shouldNotifyWatchersOfAllResourcesWhenReceivingADesignAggregateUpdateCompletedEvent() {
        ...
        final DesignDocumentUpdateCompleted designDocumentUpdateCompleted1 = new DesignDocumentUpdateCompleted(Uuids.timeBased(), designId1);

        final DesignDocumentUpdateCompleted designDocumentUpdateCompleted2 = new DesignDocumentUpdateCompleted(Uuids.timeBased(), designId2);
