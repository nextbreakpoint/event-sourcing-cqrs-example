...
public class CreateTileController implements Controller<TileCreated, ControllerResult> {
    private final Logger logger = LoggerFactory.getLogger(CreateTileController.class.getName());
    ...
    public CreateTileController(WorkerExecutor executor, S3AsyncClient s3AsyncClient, String bucket, String topic, KafkaProducer<String, String> producer, Mapper<TileCompleted, Message> mapper) {
        this.retries = 3;
