...
public class TileCreatedController implements Controller<TileCreated, ControllerResult> {
    ...
    public TileCreatedController(Store store, WorkerExecutor executor, S3AsyncClient s3AsyncClient, String bucket, String topic, KafkaProducer<String, String> producer, Mapper<TileCompleted, Message> mapper) {
        this.retries = 3;
