...
public class DeleteDesignController implements Controller<DeleteDesignRequest, DeleteDesignResponse> {
    ...
    private final Mapper<DesignDeleteCommand, OutputMessage> outputMapper;
    private final MessageEmitter emitter;

    public DeleteDesignController(Mapper<DeleteDesignRequest, DesignDeleteCommand> inputMapper, Mapper<DesignDeleteCommand, OutputMessage> outputMapper, MessageEmitter emitter) {
