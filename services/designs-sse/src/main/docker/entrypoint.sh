...
java -Xmx1024M -Dnetworkaddress.cache.ttl=1 --add-modules java.xml.bind -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory --add-opens java.base/java.nio=ALL-UNNAMED --add-opens java.base/sun.nio.ch=ALL-UNNAMED --add-opens java.base/sun.net.dns=ALL-UNNAMED -jar /maven/$SERVICE_JAR /config/$CONFIG_NAME
