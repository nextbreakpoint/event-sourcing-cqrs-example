...
class DesignDocumentUpdateCompletedControllerTest {
    ...
    private final DesignDocumentUpdateCompletedController controller = new DesignDocumentUpdateCompletedController(publisher);

    @Test
    void shouldPublishNotification() {
        final var inputMessage = TestFactory.createInputMessage(aMessageId(), "001", dateTime, aDesignDocumentUpdateCompleted(DESIGN_ID_1, COMMAND_ID_1, REVISION_1));
