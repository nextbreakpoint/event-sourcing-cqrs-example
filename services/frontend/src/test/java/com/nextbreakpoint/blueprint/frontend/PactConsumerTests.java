...
public class PactConsumerTests {
    ...
    public V4Pact retrieveDesigns(PactBuilder builder) {
        ...
        final String checksum = Checksum.of(json);
                    ...
                    new PactDslJsonBody()
                        .array("designs")
                            .object()
                                ...
                                .stringMatcher("revision", ".+", "0000000000000000-0000000000000001")
                                .stringMatcher("json", ".+", json)
                                .datetime("created", "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", TimeZone.getTimeZone("UTC"), now)
                                .datetime("updated", "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", TimeZone.getTimeZone("UTC"), now)
                                .booleanValue("published", true)
                                .integerType("levels", 8)
                                .array("tiles")
                                    .object()
                                        .integerType("level", 0)
                                        .integerType("total", 1)
                                        .integerType("completed", 1)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 1)
                                        .integerType("total", 4)
                                        .integerType("completed", 4)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 2)
                                        .integerType("total", 16)
                                        .integerType("completed", 16)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 3)
                                        .integerType("total", 64)
                                        .integerType("completed", 64)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 4)
                                        .integerType("total", 256)
                                        .integerType("completed", 256)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 5)
                                        .integerType("total", 1024)
                                        .integerType("completed", 1024)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 6)
                                        .integerType("total", 4096)
                                        .integerType("completed", 4096)
                                        .closeObject()
                                    .object()
                                        .integerType("level", 7)
                                        .integerType("total", 16384)
                                        .integerType("completed", 16384)
                                        .closeObject()
                                    .closeArray()
                                .closeObject()
                            .object()
                                ...
                                .stringMatcher("checksum", ".+", checksum)
                                .stringMatcher("revision", ".+", "0000000000000000-0000000000000000")
                                .stringMatcher("json", ".+", json)
                                .datetime("created", "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", TimeZone.getTimeZone("UTC"), now)
                                .datetime("updated", "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", TimeZone.getTimeZone("UTC"), now)
...
//  }
    ...
    public V4Pact retrieveDesignWhenUsingCQRS(PactBuilder builder) {
        ...
        final Instant now = Instant.now();
        return builder.usingLegacyDsl()
                .given("there is a published design")
                .uponReceiving("request to fetch design")
                .method("GET")
...
//  }
    ...
    public void shouldRetrieveDesignsWhenUsingCQRS(MockServer mockServer) throws IOException {
        Request.get(mockServer.getUrl() + "/v1/designs?draft=true")
                .addHeader("Accept", "application/json")
                .addHeader("Authorization", "Bearer abcdef")
                .execute()
                .handleResponse(httpResponse -> {
