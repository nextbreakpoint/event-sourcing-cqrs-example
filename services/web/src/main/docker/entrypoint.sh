...
java -Xmx512M --add-modules java.xml.bind -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory -jar /maven/$SERVICE_JAR /config/$CONFIG_NAME
