...
let DesignItem = class DesignItem extends React.Component {
    ...
    render() {
        ...
        if (this.props.role == 'admin') {
            ...
            return <tr><td></td><td><img className="z-depth-3" width={128} height={128} src={this.props.config.designs_url + "/api/designs/" + design.uuid + "/0/0/0/256.png?t=" + this.props.modified}/></td><td><a href={"/admin/designs/" + design.uuid}>{design.uuid}</a></td></tr>
        }
    }
}
